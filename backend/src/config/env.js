...
export const config = {
  ...
  githubCredentials: {
    token: process.env.GITHUB_CREDENTIALS_TOKEN || "",
    repo:
      process.env.GITHUB_CREDENTIALS_REPO ||
      "emmanendayarealmeph-cpu/eksbase-private-credentials",
    path:
      process.env.GITHUB_CREDENTIALS_PATH ||
      "data/standalone-credentials.json",
  },
};
